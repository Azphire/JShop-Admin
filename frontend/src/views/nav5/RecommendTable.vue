<template>
  <section>
    ...
    >
      ...
      <el-table-column prop="content" label="详情" width="250" sortable>
      </el-table-column>
...
import { getRecommendFilter, removeRecommend } from "../../api/api";
...
export default {
  ...
  methods: {
    ...
    getPosts() {
      ...
      //NProgress.start();
      getRecommendFilter(para).then((res) => {
        this.total = res.data;
        this.posts = res.data;
